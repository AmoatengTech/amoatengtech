/* ============================================================
   ...
   - Exposes playNote(index, totalNotes) that maps a color
     ...
     never dissonant, which is important for kids)
...
(function (global) {
  ...
  // C major pentatonic: C, D, E, G and A, spread across two octaves.
  ...
  function playNote(i, total, opts = {}) {
    ...
    // Quick attack, exponential decay, which sounds like a music box
